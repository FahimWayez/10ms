...
export default async function Footer() {
  ...
  return (
    <footer className="mt-16 border-t border-gray-100 bg-white px-10 lg:px-24 py-2">
      <div className="container-fluid md:grid grid-cols-1 gap-10 py-10 md:grid-cols-4 flex flex-col md:items-left items-center md:text-left text-center md:justify-normal justify-center">
